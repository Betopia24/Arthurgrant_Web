...
const LearnEnglishHero = () => {
  return (
    <div className="pt-28 pb-24 sm:pt-36 sm:pb-24 bg-gradient-to-br from-brand-dark via-brand-darker to-brand-darker">
...
export default LearnEnglishHero;
