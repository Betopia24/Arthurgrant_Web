      ...
      <div className="rounded-xl p-5 md:p-8 bg-[#101231] space-y-20">
        <div>
          <h3 className="text-white font-semibold text-xl">
            Arrange the words from a correct sentence:
          </h3>
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex flex-wrap gap-8">
            <button className="gradient-button w-fit">the</button>
            <button className="gradient-button w-fit">fish</button>
            <button className="gradient-button w-fit">lazy</button>
          </div>
        </div>

        <div className="flex flex-col gap-2">
          <span className="">Your sentence:</span>
          <div className="bg-[#FFFFFF1C] rounded-xl p-6">
            <h1 className="font-semibold text-xl text-white">the lazy fish</h1>
          </div>
        </div>
