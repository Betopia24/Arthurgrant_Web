...
interface WordsResponseType {
  words: string[];
}

const WordFlash = ({ taskResult, onTaskComplete }: WordFlashProps) => {
  ...
  if (isLoading && words.length === 0) {
    return (
      <div className="p-4 sm:p-5 md:p-6 lg:p-8 bg-[#FFFFFF1F] border border-white/15 rounded-2xl flex flex-col gap-4 sm:gap-5 md:gap-6 w-full max-w-full">
        <div className="rounded-xl p-4 sm:p-5 md:p-6 lg:p-8 bg-[#101231] space-y-16 sm:space-y-20 flex items-center justify-center min-h-[200px]">
          <div className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 border-2 border-white/30 border-t-white rounded-full animate-spin" />
      ...
      <div className="rounded-xl p-4 sm:p-5 md:p-6 lg:p-8 bg-[#101231] space-y-6 sm:space-y-8">
        <div className="text-center sm:text-left">
          ...
          <p className="text-white text-sm sm:text-base opacity-90">
            Click Next/Previous to see the word for 3 seconds, then record your
            speech and check with AI.
          </p>
        </div>
