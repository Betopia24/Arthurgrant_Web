...
const PhonemeGraphemeMapping = ({
  ...
  const [aiResult, setAiResult] = useState<boolean | null>(null);
  ...
  return (
    <div className="p-5 md:p-8 bg-[#FFFFFF1F] border border-white/15 rounded-2xl flex flex-col gap-6 w-full">
          ...
          <>
            ...
            <div className="flex flex-col items-center justify-center gap-4">
              ...
              <p className="text-gray-300 text-sm">
                {/* Click to hear the word: <span className="font-semibold text-white">{currentExercise.word}</span> */}
            ...
            <div className="flex items-center justify-center">
              <div className="bg-[#1a1a3e] border-2 border-dashed border-gray-500 rounded-xl px-8 py- min-h-[60px] flex items-center justify-center gap-2">
      ...
      <button
        ...
        disabled={
          selectedOptions.length === 0 || isLoading || taskResult !== null
        }
